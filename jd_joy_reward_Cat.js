...
[task_local]
#宠汪汪积分兑换奖品
59 7,15,23 * * * jd_joy_reward_Cat.js, tag=宠汪汪积分兑换奖品, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true

==============Loon==============
[Script]
cron "59 7,15,23 * * *" script-path=jd_joy_reward_Cat.js,tag=宠汪汪积分兑换奖品

================Surge===============
宠汪汪积分兑换奖品 = type=cron,cronexp="59 7,15,23 * * *",wake-system=1,timeout=3600,script-path=jd_joy_reward_Cat.js

===============小火箭==========
宠汪汪积分兑换奖品 = type=cron,script-path=jd_joy_reward_Cat.js, cronexpr="59 7,15,23 * * *", timeout=3600, enable=true
 */
// prettier-ignore
...
const JD_API_HOST = '61.49.99.122';
