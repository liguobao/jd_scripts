...
[task_local]
#京东保价
34 8,21 1-28/3 * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_price.js, tag=京东保价, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "34 8,21 1-28/3 * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_price.js,tag=京东保价

===============Surge=================
京东保价 = type=cron,cronexp="34 8,21 1-28/3 * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_price.js

============小火箭=========
京东保价 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_price.js, cronexpr="34 8,21 1-28/3 * *", timeout=3600, enable=true
 */
const $ = new Env('京东保价');
