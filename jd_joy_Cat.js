/*
jd宠汪汪 搬的https://github.com/uniqueque/QuantumultX/blob/4c1572d93d4d4f883f483f907120a75d925a693e/Script/jd_joy_Cat.js
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
IOS用户支持京东双账号,NodeJs用户支持N个京东账号
更新时间：2021-6-6
活动入口：京东APP我的-更多工具-宠汪汪
建议先凌晨0点运行jd_joy_Cat.js脚本获取狗粮后，再运行此脚本(jd_joy_steal.js)可偷好友积分，6点运行可偷好友狗粮
...
[task_local]
#京东宠汪汪
59 59 23,7,15 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_joy_Cat.js, tag=京东宠汪汪, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true

============Loon===========
[Script]
cron "59 59 23,7,15 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_joy_Cat.js,tag=京东宠汪汪

============Surge==========
[Script]
京东宠汪汪 = type=cron,cronexp="59 59 23,7,15 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_joy_Cat.js

===============小火箭==========
京东宠汪汪 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_joy_Cat.js, cronexpr="59 59 23,7,15 * * *", timeout=3600, enable=true
*/
...
function doScanMarket(type, body) {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: `//jdjoy.jd.com/common/pet/icon/click?iconCode=${type}&linkAddr=${body}&reqSource=h5&invokeKey=qRKHmL4sna8ZOP9F`,
      // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
      method: "GET",
      credentials: "include",
      header: {"content-type": "application/json"}
...
function dofollowShop(shopId) {
  return new Promise(resolve => {
    ...
    let opt = {
      // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
      url: `//jdjoy.jd.com/common/pet/icon/click?iconCode=follow_shop&linkAddr=${shopId}&reqSource=h5&invokeKey=qRKHmL4sna8ZOP9F`,
      method: "GET",
      credentials: "include",
