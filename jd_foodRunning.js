/*
* 路径：京东APP-》美食馆-》右侧瓜分京豆
* cron 11 8,20 * * * jd_foodRunning.js
[task_local]
#零食街
11 8,20 * * * jd_foodRunning.js, tag=零食街, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "11 8,20 * * *" script-path=jd_foodRunning.js, tag=零食街

====================Surge================
零食街 = type=cron,cronexp=11 8,20 * * *,wake-system=1,timeout=3600,script-path=jd_foodRunning.js

============小火箭=========
零食街 = type=cron,script-path=jd_foodRunning.js, cronexpr="0 0,6,12,18 * * *", timeout=3600, enable=true
