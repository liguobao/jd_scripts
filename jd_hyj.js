/*
20 1-23/5 * * * 环游记 自动入会、签到、任务、升级、开宝箱、捡金币 jd_hyj.js
 */
const $ = new Env('环游记');
...
function travel_collectScore(taskToken, taskId) {
    let body = { "taskId": taskId, "taskToken": taskToken, "actionType": 1, "ss": { "extraData": { "log": "-1", "sceneid": "HYJhPageh5" }, "secretp": secretp, "random": randomString(6) } };
