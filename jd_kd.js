...
[task_local]
#京东快递签到
10 3 * * * jd_kd.js, tag=京东快递签到, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_kd.png, enabled=true

================Loon==============
[Script]
cron "10 3 * * *" script-path=jd_kd.js, tag=京东快递签到

===============Surge=================
京东快递签到 = type=cron,cronexp="10 3 * * *",wake-system=1,timeout=3600,script-path=jd_kd.js

============小火箭=========
京东快递签到 = type=cron,script-path=jd_kd.js, cronexpr="10 3 * * *", timeout=3600, enable=true
 */
