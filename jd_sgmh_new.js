...
[task_local]
#闪购盲盒
20 8,11 * * * jd_sgmh_new.js, tag=闪购盲盒, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "20 8,11 * * *" script-path=jd_sgmh_new.js, tag=闪购盲盒

===============Surge=================
闪购盲盒 = type=cron,cronexp="20 8,11 * * *",wake-system=1,timeout=3600,script-path=jd_sgmh_new.js

============小火箭=========
闪购盲盒 = type=cron,script-path=jd_sgmh_new.js, cronexpr="20 8,11 * * *", timeout=3600, enable=true
...
const inviteCodes = ['T019v_R7SRsR8UnQKRv0kPACjVQmoaT5kRrbA','T0225KkcRRtI9VaFJhr0l_QMIgCjVQmoaT5kRrbA'];
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: `http://share.jdym.cc/api/v3/sgmh/query/${randomCount}/`,
      'timeout': 10000
    }, (err, resp, data) => {
      try {
        if (err) {
