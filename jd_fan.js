...
cron 34 5,15 * * * https://raw.githubusercontent.com/star261/jd/main/scripts/jd_fan.js

[task_local]
#粉丝互动
34 5,15 * * *jd_fan.js, tag=粉丝互动, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "13 1,22,23 * * *" script-path=jd_fan.js, tag=粉丝互动

====================Surge================
粉丝互动 = type=cron,cronexp="13 1,22,23 * * *",wake-system=1,timeout=3600,script-path=jd_fan.js

============小火箭=========
粉丝互动 = type=cron,script-path=jd_fan.js, cronexpr="13 1,22,23 * * *", timeout=3600, enable=true
