...
!(async () => {
  ...
  // 助力
  let res = [], res2 = [];
  $.innerShInviteList = await getAuthorShareCode('http://124.156.143.77/sharecode.php?type=smallhome&inviteCode=1');
  res2 = await getAuthorShareCode('http://124.156.143.77/sharecode.php?type=smallhome&inviteCode=1');
  $.ShInviteLists = []
  if (ShHelpAuthorFlag) {
