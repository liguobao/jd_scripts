...
[task_local] 
#点点券 
49 0,6,13,20 * * * jd_necklace.js, tag=点点券, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true 

================Loon============== 
[Script] 
cron "49 0,6,13,20 * * *" script-path=jd_necklace.js,tag=点点券 

===============Surge================= 
点点券 = type=cron,cronexp="49 0,6,13,20 * * *",wake-system=1,timeout=3600,script-path=jd_necklace.js 

============小火箭========= 
点点券 = type=cron,script-path=jd_necklace.js, cronexpr="49 0,6,13,20 * * *", timeout=3600, enable=true 
 */ 
const $ = new Env('点点券改UA版'); 
let allMessage = ``; 
...
const vm = require('vm'); 
const UA = require('./DD_USER_AGENTS.js').USER_AGENT; 
