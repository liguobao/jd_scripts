...
[task_local]
#摇京豆
5 2,23 * * * jd_club_lottery.js, tag=摇京豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdyjd.png, enabled=true
=================Loon===============
[Script]
cron "5 2,23 * * *" script-path=jd_club_lottery.js,tag=摇京豆
=================Surge==============
[Script]
摇京豆 = type=cron,cronexp="5 2,23 * * *",wake-system=1,timeout=3600,script-path=jd_club_lottery.js

============小火箭=========
摇京豆 = type=cron,script-path=jd_club_lottery.js, cronexpr="5 2,23 * * *", timeout=3600, enable=true
*/
