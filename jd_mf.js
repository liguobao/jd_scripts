...
[task_local]
#京东小魔方
31 12,20 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_mf.js, tag=京东小魔方, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "31 12,20 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_mf.js,tag=京东小魔方

===============Surge=================
京东小魔方 = type=cron,cronexp="31 12,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_mf.js

============小火箭=========
京东小魔方 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_mf.js, cronexpr="31 12,20 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东小魔方');
...
async function getInteractionInfo(type = true) {
  ...
  return new Promise(async (resolve) => {
    $.post(taskPostUrl("getInteractionInfo", body), async (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
