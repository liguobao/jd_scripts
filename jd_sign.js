...
[task_local]
#京东签到图形验证
10 0-23/8 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_sign.js, tag=京东签到图形验证, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true

=======Loon========
[Script]
cron "10 0-23/8 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_sign.js,tag=京东签到图形验证

========Surge==========
京东签到图形验证 = type=cron,cronexp="10 0-23/8 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_sign.js

=======小火箭=====
京东签到图形验证 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_sign.js, cronexpr="10 0-23/8 * * *", timeout=3600, enable=true
